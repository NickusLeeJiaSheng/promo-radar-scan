...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DealHub — Deal discovery for Singapore" },
      {
        name: "description",
        content:
          "Promotions from Telegram channels, cleaned up into searchable, location-aware deal cards.",
      },
      { name: "author", content: "DealHub" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {/* HeadContent injects meta/link tags into <head> managed by TanStack Router */}
      <HeadContent />
